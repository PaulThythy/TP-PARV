...
GLuint LoadComputeShader(const char * compute_file_path) {
    ...
    if(ComputeShaderStream.is_open()) {
        ...
        std::cerr << "Impossible d'ouvrir " << compute_file_path << std::endl;
        return 0;
    }
    ...
    const char* sourcePtr = ComputeShaderCode.c_str();
    glShaderSource(ComputeShaderID, 1, &sourcePtr, NULL);
    ...
    if( InfoLogLength > 0 ){
        ...
        glGetShaderInfoLog(ComputeShaderID, InfoLogLength, NULL, &ErrorMessage[0]);
